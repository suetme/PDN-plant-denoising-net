...
parser.add_argument('--input_xyz', type=str, default='./demo/large_example.xyz')
parser.add_argument('--output_xyz', type=str, default='./demo/large_example_denoising.xyz')
parser.add_argument('--device', type=str, default='cuda')
parser.add_argument('--seed', type=int, default=2020)
# Denoiser parameters
parser.add_argument('--cluster_size', type=int, default=40000)
